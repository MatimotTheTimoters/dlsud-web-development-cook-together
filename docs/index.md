...
##### src/api/activity.js
- **Description**: API functions for activity feed operations
- **Required Imports**: api from '../utils/api'
- **Backend Endpoint**: api/activity/feed.php
- **Functions**:
  - `getActivityFeed(limit, offset) -> promise`: Gets activity feed
  - `getUserActivities(userId) -> promise`: Gets specific user activities
